...
public class Service {
    ...
    public Service(StudentXMLRepository studentXmlRepo, HomeworkXMLRepository temaXmlRepo, GradeXMLRepository gradeXmlRepo) {
        this.studentXmlRepo = studentXmlRepo;
        this.homeworkXmlRepo = temaXmlRepo;
    ...
    public int saveHomework(String id, String descriere, int deadline, int startline) {
        Homework homework = new Homework(id, descriere, deadline, startline);
    ...
    public void createStudentFile(String idStudent, String idTema) {
        Grade grade = gradeXmlRepo.findOne(new Pair(idStudent, idTema));
